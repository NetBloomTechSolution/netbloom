              ...
              <div class="col-lg-6">
                  <div class="tp-team-details-wrapper">
                      <div class="tp-team-details-text">
                          <span class="tp-team-details-text-sub">Founder & CEO</span>
                          <h4 class="tp-team-details-text-title">Logan Dang</h4>
                      ...
                      <div class="tp-team-details-more mb-50">
                          <h4 class="tp-team-details-more-title">More details</h4>
                          <ul>
                      ...
                      <div class="tp-team-details-more mb-50">
                          <h4 class="tp-team-details-more-title">Experience</h4>
                          <ul>
                      ...
                      <div class="tp-team-details-progress mb-50">
                          <h4 class="tp-team-details-more-title mb-35">My Skills</h4>
                          <div class="tp-team-details-progress mb-35">
                              <h6 class="tp-team-details-progress-title">UX Design</h6>
                              <div class="tp-team-details-progress-inner">
                                  <div class="tp-team-details-progress-bar" role="progressbar" data-width="75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                      <h6 class="tp-team-details-progress-counter">
                                        <counter-item :min="0" :max="75" :no-itag="true" />%
                                      </h6>
                                  </div>
                              </div>
                          </div>
                          <div class="tp-team-details-progress mb-35">
                              <h6 class="tp-team-details-progress-title">API Development</h6>
                              <div class="tp-team-details-progress-inner">
                                  <div class="tp-team-details-progress-bar" role="progressbar" data-width="82%" aria-valuenow="82" aria-valuemin="0" aria-valuemax="100">
                                      <h6 class="tp-team-details-progress-counter">
                                        <counter-item :min="0" :max="82" :no-itag="true" />%
                                      </h6>
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div class="tp-team-details-input mb-50">
                          <h4 class="tp-team-details-more-title mb-35">Think I can help?</h4>
                          <div class="tp-team-details-input-content">
                              <div class="row gx-20">
                                  <div class="col-lg-6">
                              ...
                              <div class="tp-team-details-input-btn">
