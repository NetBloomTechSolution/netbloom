...
const testimonial_data = [
  {
    ...
    name: "Bradley Gordon",
    position: "Co-Founder of Netbloom",
    rating: 5,
    quote:
      "Netbloom went above and beyond to make sure we got something we were happy with.",
  },
  {
    id: 2,
    ...
    rating: 5,
    quote:
      "The team at Netbloom was incredibly attentive and made sure every detail was perfect.",
  },
  {
    id: 3,
    ...
    rating: 5,
    quote:
      "We're beyond satisfied — Netbloom made the entire process seamless and rewarding.",
  },
  {
    id: 4,
    ...
    rating: 5,
    quote:
      "From start to finish, Netbloom went the extra mile to ensure we were thrilled with the result.",
  },
];
</script>
